  ...
  onSubmitRegister =()=>{
    ...
    window.alert('Sorry! The required fields cannot be blank.')
      ...
      .then(user =>{
        ...
        window.alert('Hi!!! Welcome you on detecting faces!!!')
        } else{
      ...
      <article className="br4 ba b--black-10 mv4 w-100 w-50-m w-25-l mw5 shadow-5 center">
        ...
        <div className="measure">
          <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
            ...
            <div className="mv3">
              <label className="db fw6 lh-copy f6" htmlFor="password">Password <span className="f9 fw4">(min 6 characters)</span></label>
              <input 
